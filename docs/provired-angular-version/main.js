"use strict";
(self["webpackChunkprovired_angular_version"] = self["webpackChunkprovired_angular_version"] || []).push([["main"],{
...
const routes = [{
  ...
  path: '',
  loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_views_views_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./views/views.module */ 5397)).then(m => m.ViewsModule)
}];
...
class AppComponent {
  constructor(primengConfig) {
    ...
    this.title = 'provired-angular-version';
    this.theme = 'blue';
